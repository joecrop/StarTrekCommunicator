/**************************************************************************/
/*!
    @file     Adafruit_Teensy_LIS3DH.cpp
    @author   K. Townsend / Limor Fried (Adafruit_Teensy Industries)
    @license  BSD (see license.txt)

    This is a library for the Adafruit_Teensy LIS3DH Accel breakout board
    ----> https://www.Adafruit_Teensy.com/products/2809

    Adafruit_Teensy invests time and resources providing this open source code,
    please support Adafruit_Teensy and open-source hardware by purchasing
    products from Adafruit_Teensy!
...
/**************************************************************************/
// I2C
Adafruit_Teensy_LIS3DH::Adafruit_Teensy_LIS3DH()
  : _cs(-1), _mosi(-1), _miso(-1), _sck(-1), _sensorID(-1)
{
}

Adafruit_Teensy_LIS3DH::Adafruit_Teensy_LIS3DH(int8_t cspin)
  : _cs(cspin), _mosi(-1), _miso(-1), _sck(-1), _sensorID(-1)
{ }

Adafruit_Teensy_LIS3DH::Adafruit_Teensy_LIS3DH(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin)
...
*/
/**************************************************************************/
bool Adafruit_Teensy_LIS3DH::begin(uint8_t i2caddr) {
  _i2caddr = i2caddr;
...
void Adafruit_Teensy_LIS3DH::read(void) {
  // read x y z at once
...
int16_t Adafruit_Teensy_LIS3DH::readADC(uint8_t adc) {
...
void Adafruit_Teensy_LIS3DH::setClick(uint8_t c, uint8_t clickthresh, uint8_t timelimit, uint8_t timelatency, uint8_t timewindow) {
  if (!c) {
    //disable int
...
uint8_t Adafruit_Teensy_LIS3DH::getClick(void) {
...
*/
/**************************************************************************/
void Adafruit_Teensy_LIS3DH::setRange(lis3dh_range_t range)
{
...
*/
/**************************************************************************/
lis3dh_range_t Adafruit_Teensy_LIS3DH::getRange(void)
{
...
*/
/**************************************************************************/
void Adafruit_Teensy_LIS3DH::setDataRate(lis3dh_dataRate_t dataRate)
{
...
*/
/**************************************************************************/
lis3dh_dataRate_t Adafruit_Teensy_LIS3DH::getDataRate(void)
{
...
*/
/**************************************************************************/
bool Adafruit_Teensy_LIS3DH::getEvent(sensors_event_t *event) {
  /* Clear the event */
...
*/
/**************************************************************************/
void Adafruit_Teensy_LIS3DH::getSensor(sensor_t *sensor) {
...
uint8_t Adafruit_Teensy_LIS3DH::spixfer(uint8_t x) {
  #ifndef __AVR_ATtiny85__
  if (_sck == -1)
...
*/
/**************************************************************************/
void Adafruit_Teensy_LIS3DH::writeRegister8(uint8_t reg, uint8_t value) {
  if (_cs == -1) {
...
*/
/**************************************************************************/
uint8_t Adafruit_Teensy_LIS3DH::readRegister8(uint8_t reg) {
  uint8_t value;
