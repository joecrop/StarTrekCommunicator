...
class Adafruit_Teensy_LIS3DH : public Adafruit_Sensor {
 public:
  Adafruit_Teensy_LIS3DH(void);
  Adafruit_Teensy_LIS3DH(int8_t cspin);
  Adafruit_Teensy_LIS3DH(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
